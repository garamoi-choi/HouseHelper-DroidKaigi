                ...
                navigation<Onboarding>(startDestination = OnboardingWelcome) {
                    composable<OnboardingWelcome> {
                        OnboardingScreen(
                            ...
                            subText = stringResource(Res.string.onboarding_welcome_subtitle),
                    ...
                    composable<OnboardingAbout> {
                        OnboardingScreen(
                            ...
                            subText = stringResource(Res.string.onboarding_about_subtitle),
                            buttonText = stringResource(Res.string.onboarding_next_button),
                    ...
                    composable<OnboardingDone> {
                        OnboardingScreen(
                            ...
                            subText = stringResource(Res.string.onboarding_done_subtitle),
                            buttonText = stringResource(Res.string.onboarding_next_button),
